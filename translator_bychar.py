...
checkpoint = ModelCheckpoint("{}-best.h5".format("translate"), monitor='val_loss', verbose=1, save_best_only=True, mode='min')
callbacks_list = [checkpoint]
model.fit(x=[tokenized_eng_sentences,tokenized_fra_sentences], y=target_data, batch_size=64, callbacks=callbacks_list, epochs=3, validation_split=0.2)
